...
object Dependencies {
  ...
  val http4sOkHttpClient = "org.http4s" %% "http4s-okhttp-client" % Versions.http4sVersion
  ...
  val http4s             = Seq(http4sDsl, http4sOkHttpClient, http4sBlazeServer, http4sCirce)
