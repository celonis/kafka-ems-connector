...
object Dependencies {
  ...
  object Versions {
    ...
    val jdkHttpClientVersion = "0.7.0"
  ...
  val http4sJdkHttpClient = "org.http4s" %% "http4s-jdk-http-client" % Versions.jdkHttpClientVersion
  ...
  val http4s              = Seq(http4sDsl, http4sJdkHttpClient, http4sBlazeServer, http4sCirce)
